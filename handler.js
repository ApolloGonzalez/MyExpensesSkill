...
const handlers = {
    ...
    'Prompt': function() {
        this.emit(':ask', 'Hey there and Welcome to Expense management. I can do a couple of things: Add an expense, delete an expense, get an expense and update an expense. Let me know how I can help', 'Please say that again?');
    },
    'PromptGet': function() {
        this.emit(':ask', 'Please tell me what expense category you would like to check', 'Please say that again?');
    },
    'NoMatch': function() {
